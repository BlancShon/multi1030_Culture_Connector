        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
          <div class="card border border-light-subtle rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <a style="border: none;" href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=28661b9849fd4704ad288e59fe9b571c&redirect_uri=http://localhost/mvc/member/enroll/kakao">카카오</a>) </h6>
              </div>
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="d-flex gap-2 gap-sm-3 justify-content-center">
                   ...
                   <a id="btn" href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=28661b9849fd4704ad288e59fe9b571c&redirect_uri=http://localhost/mvc/kakaoLogin" class="btn btn-lg btn-outline-success p-3 lh-1" style="">
