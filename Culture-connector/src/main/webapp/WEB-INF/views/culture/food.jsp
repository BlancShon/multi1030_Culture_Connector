				...
				<div class="row height d-flex justify-content-center align-items-center">
					<div class="col-md-10 ">
						...
						<div class="search">
							...
							<input type="text" class="form-control" style="font-size: large" placeholder="맛집 이름을 검색하세요.">
									...
									<div class="position-absolute top-100 start-50 translate-middle w-100">
										<div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
											<h6 class="card-title mb-1"><a href="#"
													style="text-align: left;">신당동 떡볶이 타운</a><br>
										
											</h6>
											<medium style="color: black;">서울 중구</medium><br>
											<small>인기 메뉴 : 떡볶이</small><br>
								...
								<div class="card">
									...
									<div class="position-absolute top-100 start-50 translate-middle w-100">
										<div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
											...
											<medium style="color: black;">경기도 김포시</medium><br>
											<small>인기 메뉴 :판다 티라미수</small><br>
								...
								<div class="card">
									...
									<div class="position-absolute top-100 start-50 translate-middle w-100">
										<div class="card-body text-center bg-mode shadow rounded mx-4 p-3">
											...
											<medium style="color: black;">부산 민락동</medium><br>
											<small>인기 메뉴 : 매운탕, 회</small><br>
						...
						<div class="row g-4 g-md-5">
							...
							<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
								<div class="card bg-transparent text-center p-1 h-100">
									...
									<div class="card-body p-0 pt-3">
										<h5 class="card-title"><a href="cuisine-search.html" class="stretched-link">한식</a></h5>
									</div>
								</div>
							</div>
